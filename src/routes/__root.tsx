...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Portfolio of Vaibhav Sharma, B.Tech CSE student at LPU building intelligent systems with AI and scalable web technologies." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Vaibhav Sharma — AI & Full-Stack Developer" },
      { name: "twitter:description", content: "Portfolio of Vaibhav Sharma, B.Tech CSE student at LPU building intelligent systems with AI and scalable web technologies." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/adf08383-57d4-4233-8cac-34f6fb391ae3/id-preview-dffa9ba8--41406559-d306-42c8-8683-0a91b18b8884.lovable.app-1777450979220.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/adf08383-57d4-4233-8cac-34f6fb391ae3/id-preview-dffa9ba8--41406559-d306-42c8-8683-0a91b18b8884.lovable.app-1777450979220.png" },
    ],
    links: [
